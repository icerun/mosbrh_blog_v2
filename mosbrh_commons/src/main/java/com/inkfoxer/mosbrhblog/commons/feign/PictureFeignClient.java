...
import com.inkfoxer.mosbrhblog.commons.fallback.PictureFeignFallback;
 ...
 * @author 灵雨
 */
@FeignClient(name = "mosbrh-picture", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
