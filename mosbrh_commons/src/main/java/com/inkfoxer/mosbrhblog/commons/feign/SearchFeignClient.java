package com.inkfoxer.mosbrhblog.commons.feign;

import com.inkfoxer.mosbrhblog.commons.config.feign.FeignConfiguration;
import com.inkfoxer.mosbrhblog.commons.fallback.SearchFeignFallback;
 ...
 */
@FeignClient(name = "mosbrh-search", contextId = "searchFeignClient", configuration = FeignConfiguration.class, fallback = SearchFeignFallback.class)
