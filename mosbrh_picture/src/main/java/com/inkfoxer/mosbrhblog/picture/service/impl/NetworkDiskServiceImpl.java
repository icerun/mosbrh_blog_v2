...
import com.inkfoxer.mosbrhblog.commons.entity.NetworkDisk;
import com.inkfoxer.mosbrhblog.commons.entity.Storage;
import com.inkfoxer.mosbrhblog.picture.global.SQLConf;
import com.inkfoxer.mosbrhblog.picture.global.SysConf;
import com.inkfoxer.mosbrhblog.picture.mapper.NetworkDiskMapper;
import com.inkfoxer.mosbrhblog.picture.service.NetworkDiskService;
import com.inkfoxer.mosbrhblog.picture.service.StorageService;
import com.inkfoxer.mosbrhblog.picture.util.FeignUtil;
import com.inkfoxer.mosbrhblog.picture.util.MinioUtil;
import com.inkfoxer.mosbrhblog.picture.util.MosbrhFileUtil;
import com.inkfoxer.mosbrhblog.picture.util.QiniuUtil;
import com.inkfoxer.mosbrhblog.picture.vo.NetworkDiskVO;
import com.inkfoxer.mosbrhblog.utils.StringUtils;
import com.inkfoxer.mosbrhblog.utils.upload.FileUtil;
...
import com.inkfoxer.mosbrhblog.base.exception.exceptionType.UpdateException;
    ...
    public void deleteFile(NetworkDiskVO networkDiskVO, Map<String, String> qiNiuConfig) {
        ...
        if (SysConf.ONE == networkDisk.getIsDir()) {
            ...
            if (list.size() > 0) {
                ...
                if (isUpdateSuccess) {
                    ...
                    if (EOpenStatus.OPEN.equals(uploadLocal)) {
                        ...
                        // 批量删除本地图片
                        MosbrhFileUtil.deleteFileList(fileList);
                    }
                    // 删除七牛云上文件
            ...
            if (EOpenStatus.OPEN.equals(uploadLocal)) {
                ...
                MosbrhFileUtil.deleteFile(UPLOAD_PATH + localUrl);
            }
            // 删除七牛云上文件
            if (EOpenStatus.OPEN.equals(uploadQiNiu)) {
