...
public class MosbrhFileUtil {
    ...
    public static boolean deleteDirectory(String dir) {
        ...
        for (int i = 0; i < files.length; i++) {
            // 删除子文件
            if (files[i].isFile()) {
                flag = MosbrhFileUtil.deleteFile(files[i].getAbsolutePath());
                if (!flag) {
                    break;
                }
            }
            // 删除子目录
                ...
                flag = MosbrhFileUtil.deleteDirectory(files[i]
                        .getAbsolutePath());
                if (!flag) {
                    break;
                }
    ...
    public static void main(String[] args) {
        // 删除单个文件
        String file = "D:\\mosbrh_blog\\data\\blog\\admin\\webp\\2020\\6\\15\\123.txt";
        MosbrhFileUtil.deleteFile(file);
        System.out.println();

        // 删除一个目录
//        String dir = "D:/home/web/upload/upload/files";
//        MosbrhFileUtil.deleteDirectory(dir);
