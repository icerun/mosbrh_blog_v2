package com.inkfoxer.mosbrhblog.picture.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.inkfoxer.mosbrhblog.commons.entity.File;
import com.inkfoxer.mosbrhblog.commons.entity.FileSort;
import com.inkfoxer.mosbrhblog.commons.entity.SystemConfig;
import com.inkfoxer.mosbrhblog.picture.global.MessageConf;
import com.inkfoxer.mosbrhblog.picture.global.SQLConf;
import com.inkfoxer.mosbrhblog.picture.global.SysConf;
import com.inkfoxer.mosbrhblog.picture.mapper.FileMapper;
import com.inkfoxer.mosbrhblog.picture.service.*;
import com.inkfoxer.mosbrhblog.picture.util.AboutFileUtil;
import com.inkfoxer.mosbrhblog.picture.util.FeignUtil;
import com.inkfoxer.mosbrhblog.utils.FileUtils;
...
import com.inkfoxer.mosbrhblog.base.enums.EFilePriority;
import com.inkfoxer.mosbrhblog.base.enums.EOpenStatus;
import com.inkfoxer.mosbrhblog.base.enums.EStatus;
import com.inkfoxer.mosbrhblog.base.exception.exceptionType.InsertException;
...
public class FileServiceImpl extends SuperServiceImpl<FileMapper, File> implements FileService {
    ...
    public String getPicture(String fileIds, String code) {
        ...
        if (StringUtils.isEmpty(fileIds)) {
            ...
            QueryWrapper<com.inkfoxer.mosbrhblog.commons.entity.File> queryWrapper = new QueryWrapper<>();
            queryWrapper.in(SQLConf.UID, changeStringToString);
            List<com.inkfoxer.mosbrhblog.commons.entity.File> fileList = fileService.list(queryWrapper);
            if (fileList.size() > 0) {
                for (com.inkfoxer.mosbrhblog.commons.entity.File file : fileList) {
                    if (file != null) {
    ...
    public String batchUploadFile(HttpServletRequest request, List<MultipartFile> filedatas, SystemConfig systemConfig) {
        ...
        if (SysConf.PICTURE.equals(source)) {
            // 当从vue-mosbrh-web网站过来的，直接从参数中获取
    ...
    public String uploadPictureByUrl(FileVO fileVO) {
        ...
        List<com.inkfoxer.mosbrhblog.commons.entity.File> lists = new ArrayList<>();
        //文件上传
        if (urlList != null && urlList.size() > 0) {
            for (String itemUrl : urlList) {
                ...
                com.inkfoxer.mosbrhblog.commons.entity.File file = new com.inkfoxer.mosbrhblog.commons.entity.File();
                file.setCreateTime(new Date(System.currentTimeMillis()));
                file.setFileSortUid(fileSort.getUid());
