package com.inkfoxer.mosbrhblog.web.annotion.requestLimit;

import com.inkfoxer.mosbrhblog.utils.AspectUtil;
...
public class RequestLimitAspect {
    ...
    private final String POINT = "execution(* com.inkfoxer.mosbrhblog.web.restapi..*.*(..))";
    @Autowired
