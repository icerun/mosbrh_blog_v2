...
import com.inkfoxer.mosbrhblog.commons.entity.Feedback;
import com.inkfoxer.mosbrhblog.commons.entity.Link;
import com.inkfoxer.mosbrhblog.commons.entity.SystemConfig;
import com.inkfoxer.mosbrhblog.commons.entity.User;
import com.inkfoxer.mosbrhblog.commons.feign.PictureFeignClient;
import com.inkfoxer.mosbrhblog.utils.*;
import com.inkfoxer.mosbrhblog.web.global.MessageConf;
import com.inkfoxer.mosbrhblog.web.global.RedisConf;
import com.inkfoxer.mosbrhblog.web.global.SQLConf;
import com.inkfoxer.mosbrhblog.web.global.SysConf;
import com.inkfoxer.mosbrhblog.xo.service.*;
import com.inkfoxer.mosbrhblog.xo.utils.RabbitMqUtil;
import com.inkfoxer.mosbrhblog.xo.utils.WebUtil;
import com.inkfoxer.mosbrhblog.xo.vo.FeedbackVO;
import com.inkfoxer.mosbrhblog.xo.vo.LinkVO;
import com.inkfoxer.mosbrhblog.xo.vo.UserVO;
import com.inkfoxer.mosbrhblog.base.enums.EGender;
import com.inkfoxer.mosbrhblog.base.enums.ELinkStatus;
...
public class AuthRestApi {
    ...
    public String updateUserPwd(HttpServletRequest request, @RequestParam(value = "oldPwd") String oldPwd, @RequestParam("newPwd") String newPwd) {
        ...
        User user = userService.getById(userUid);
        // 判断是否是第三方登录的账号
        if (!user.getSource().equals(SysConf.mosbrh)) {
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(mosbrhWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(mosbrhWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(mosbrhWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
