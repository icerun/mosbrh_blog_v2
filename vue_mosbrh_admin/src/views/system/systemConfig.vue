  ...
  <div class="app-container">
    <el-tabs type="border-card" @tab-click="handleClick" v-model="activeName">
          ...
          <el-form-item>
            <template slot="label">
              ...
              <el-popover
                ...
                width="200"
                trigger="hover"
                content="用于控制门户搜索功能使用SQL方式，还是全文检索。开启全文检索需要启动mosbrh-search项目">
      ...
      <el-tab-pane name="four"  v-permission="'/systemConfig/getSystemConfig'">
        ...
        >
          <aside>
            使用 <a href="https://www.mosbrhit.cn/info/202">七牛云</a> 构建对象存储服务<br/>
          </aside>
      ...
      <el-tab-pane name="five" v-permission="'/systemConfig/getSystemConfig'">
        ...
        >
          ...
          <aside>
            使用 <a href="https://www.mosbrhit.cn/info/278">Minio</a> 构建本地对象存储服务<br/>
          </aside>
