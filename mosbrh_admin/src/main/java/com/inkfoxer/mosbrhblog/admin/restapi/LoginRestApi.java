...
import com.inkfoxer.mosbrhblog.admin.global.MessageConf;
import com.inkfoxer.mosbrhblog.admin.global.RedisConf;
import com.inkfoxer.mosbrhblog.admin.global.SQLConf;
import com.inkfoxer.mosbrhblog.admin.global.SysConf;
import com.inkfoxer.mosbrhblog.commons.config.jwt.Audience;
import com.inkfoxer.mosbrhblog.commons.config.jwt.JwtTokenUtil;
import com.inkfoxer.mosbrhblog.commons.entity.Admin;
import com.inkfoxer.mosbrhblog.commons.entity.CategoryMenu;
...
import com.inkfoxer.mosbrhblog.xo.service.CategoryMenuService;
...
import com.inkfoxer.mosbrhblog.base.enums.EMenuType;
    ...
    public String info(HttpServletRequest request,
        ...
        if (StringUtils.isNotEmpty(admin.getAvatar())) {
            ...
            if (list.size() > 0) {
                ...
                map.put(SysConf.AVATAR, "https://gitee.com/inkfoxer159753/wx_picture/raw/master/picture/favicon.png");
            }
        }
