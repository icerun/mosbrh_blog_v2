...
public class CreatCodeRestApi {
    ...
    @Value(value = "${mosbrhBlog.email}")
    private String mosbrhBlogEmail;
    ...
    public String validCode(HttpServletRequest request,
        ...
        String text =
                "<html>\r\n" +
                        ...
                        "<div class=\"container\">\r\n" +
                        "<div class=\"logo\">\r\n" +
                        "<img src=\"http://picture.mosbrhit.cn/blog/admin/jpg/2018/10/21/logo.jpg\",height=\"100\" width=\"100\">\r\n" +
                        "</div>\r\n" +
                        ...
                        "<p>您好 <a href=\"mailto:" + mosbrhBlogEmail + "\" rel=\"noopener\" target=\"_blank\">" + info + "<wbr></a>！</p>\r\n" +
                        "<p>欢迎注册墨上笔如花博客，请将验证码填写到注册页面。</p>\r\n" +
                        "<p>验证码：" + code + "</p>\r\n" +
                        "\r\n" +
                        "</div>\r\n" +
                        "</div>\r\n" +
        ...
        if (CheckUtils.checkEmail(info)) {
            ...
            map.put("text", text);
            //发送到RabbitMq
            rabbitTemplate.convertAndSend("exchange.direct", "mosbrh.email", map);
        }
        if (CheckUtils.checkMobileNumber(info)) {
            //code是我们申请模板时写的参数
            map.put("param", code);
            ...
            //发送到RabbitMq
            rabbitTemplate.convertAndSend("exchange.direct", "mosbrh.sms", map);
        }
