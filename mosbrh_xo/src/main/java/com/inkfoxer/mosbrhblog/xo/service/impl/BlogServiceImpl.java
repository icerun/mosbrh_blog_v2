...
import com.inkfoxer.mosbrhblog.commons.entity.*;
...
import com.inkfoxer.mosbrhblog.xo.mapper.BlogMapper;
import com.inkfoxer.mosbrhblog.xo.mapper.BlogSortMapper;
import com.inkfoxer.mosbrhblog.xo.mapper.TagMapper;
import com.inkfoxer.mosbrhblog.xo.service.*;
import com.inkfoxer.mosbrhblog.xo.utils.WebUtil;
import com.inkfoxer.mosbrhblog.xo.vo.BlogVO;
import com.inkfoxer.mosbrhblog.base.enums.*;
import com.inkfoxer.mosbrhblog.base.global.BaseSQLConf;
import com.inkfoxer.mosbrhblog.base.global.BaseSysConf;
...
public class BlogServiceImpl extends SuperServiceImpl<BlogMapper, Blog> implements BlogService {
    ...
    public String editBatch(List<BlogVO> blogVOList) {
        ...
        if (save) {
            ...
            //发送到RabbitMq
            rabbitTemplate.convertAndSend(SysConf.EXCHANGE_DIRECT, SysConf.mosbrh_BLOG, map);
        }
